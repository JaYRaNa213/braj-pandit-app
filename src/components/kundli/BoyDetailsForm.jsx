...
const BoyDetailsForm = ({
  ...
  const [isExactBirthTimeBoy, setIsExactBirthTimeBoy] = useState(true);
  ...
  return (
    ...
    >
      ...
      >
        {t('Match Kundli.newMatch.boysDetailes')}
      </Text>
      ...
      <View style={{ position: 'relative' }}>
        ...
        <TouchableOpacity onPress={() => setDatePickerVisibility(!isDatePickerVisible)}>
          <TextInput
            ...
            placeholderTextColor={isDarkMode ? colors.darkTextSecondary : colors.gray}
            value={boyBirthDate ? boyBirthDate.toLocaleDateString() : ''}
            editable={false}
          />
        </TouchableOpacity>
        <DateTimePickerModal
          ...
          mode="date"
          onConfirm={(val) => setBoyBirthDate(val)}
      ...
      <View style={{ position: 'relative' }}>
        ...
        <TouchableOpacity onPress={() => setIsTimePickerVisibility(!isTimePickerVisible)}>
          <TextInput
            ...
            placeholderTextColor={isDarkMode ? colors.darkTextSecondary : colors.gray}
            value={boyBirthTime ? moment(boyBirthTime).format('hh:mm A') : ''}
            editable={false}
          />
        </TouchableOpacity>
        ...
        <View style={{ marginTop: 20 }}>
          <TouchableOpacity
            onPress={() => setIsExactBirthTimeBoy(!isExactBirthTimeBoy)}
            style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}
          >
            <FontAwesome
              name={isExactBirthTimeBoy ? 'square-o' : 'check-square'}
              size={20}
              color={isDarkMode ? colors.darkTextSecondary : colors.gray}
            />
            <Text
        ...
        <DateTimePickerModal
          ...
          mode="time"
          onConfirm={(val) => setBoyBirthTime(val)}
